...
# A PHONY fake goal is required to make sure that Make does not expect a process
# with the name of the goal in the process system
...
## test-script: Test the executable with a curl script for quick validation
.PHONY: test-script
test-script:
