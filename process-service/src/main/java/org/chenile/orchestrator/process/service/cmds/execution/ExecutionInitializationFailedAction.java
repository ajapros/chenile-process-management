...
import org.chenile.orchestrator.process.model.payload.execution.ExecutionInitializationFailedPayload;
...
public class ExecutionInitializationFailedAction extends BaseProcessAction<ExecutionInitializationFailedPayload> {
    Logger logger = LoggerFactory.getLogger(this.getClass());

    @Override
    public void transitionTo(Process process,
                             ExecutionInitializationFailedPayload payload,
